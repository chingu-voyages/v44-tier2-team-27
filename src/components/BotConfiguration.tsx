  ...
  return (
    <div className="botConfigurationWrapper">
      ...
      <div>
        ...
        <input id="name" name="name" type="text" value={bot.name} onChange={handleNameChange} />
      </div>
      ...
      {isFormVissible && (
        <>
          ...
          <label htmlFor="operator">
            Boolean Operator:
            <select name="operator" value={bot.operator} onChange={handleChange}>
          ...
          <label htmlFor="speed">
            <input type="range" name="speed" min="1" max="5" value={bot.speed} onChange={handleChange} />
          </label>
          <label htmlFor="direction">
            Starting direction:
            <select name="direction" value={bot.direction} onChange={handleChange}>
